...
public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener,ItemFragment.OnFragmentInteractionListener,TopFragment.OnFragmentInteractionListener,LocationListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            fragmentManager.beginTransaction().replace(R.id.container, TopFragment.newInstance("hoge", "hoge")).commit();
